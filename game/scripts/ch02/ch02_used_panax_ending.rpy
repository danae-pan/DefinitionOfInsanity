label ch02_used_panax_ending:
    ...
    doctor "Don't speak mother. I've prepared something new."

    hide doctor default onlayer portraits

    "He carefully helps her sit upright and supports the cup with trembling hands."
    ...
    "Blood begins to trickle from one nostril."
    ...
    "The stimulation from the experimental formula triggered a sudden rise in blood pressure, causing a massive cerebral hemorrhage."
    ...
    doctor "And perhaps tomorrow I will be given another chance."

    doctor "If Mother wakes once more, I cannot repeat today's mistake."

    "Unable to bear the silence of the house any longer, he buries himself in books, notes, and herbal formulas in an attempt to escape the weight of what he has done."
